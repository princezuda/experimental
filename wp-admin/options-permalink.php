...
<?php wp_nonce_field('update-permalink') ?>
  ...
  <p><?php _e('By default PlanetWord offers you the ability to create a custom URL structure for your permalinks and archives. This is much better for your site.'); ?></p>
...
$structures = array(
	0 => $prefix . '/%postname%/',
	1 => $prefix . '/%year%/%monthnum%/%postname%/',
	2 => $prefix . '/' . _x( 'archives', 'sample permalink base' ) . '/%post_id%',
	3 => $prefix . '/%year%/%monthnum%/%day%/%postname%/',
);
?>
