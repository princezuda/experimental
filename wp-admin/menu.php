...
$menu[5] = array( __('Articles'), 'edit_posts', 'edit.php', '', 'open-if-no-js menu-top menu-icon-post', 'menu-posts', 'none' );
	$submenu['edit.php'][5]  = array( __('All Articles'), 'edit_posts', 'edit.php' );
	/* translators: add new post */
	$submenu['edit.php'][10]  = array( _x('Add New', 'articles'), get_post_type_object( 'post' )->cap->create_posts, 'post-new.php' );
...
$menu[60] = array( __('Appearance'), $appearance_cap, 'themes.php', '', 'menu-top menu-icon-appearance', 'menu-appearance', 'div' );
	$submenu['themes.php'][5] = array( __( 'Site Layout' ), $appearance_cap, 'themes.php' );
...
$menu[65] = array( sprintf( __('Add-ons %s'), $count ), 'activate_plugins', 'plugins.php', '', 'menu-top menu-icon-plugins', 'menu-plugins', 'none' );

$submenu['plugins.php'][5]  = array( __('Installed add-ons'), 'activate_plugins', 'plugins.php' );
