		...
		if ( 'html5' == $format ) {
			...
			$form = '<form role="search" method="get" class="search-form" action="' . esc_url( home_url( '/' ) ) . '">
				<label>
					...
					<input type="search" class="search-field" placeholder="' . esc_attr_x( 'Search &hellip;', 'placeholder' ) . '" value="' . wp_kses(get_search_query(),$allowed_html,$allowed_protocols) . '" name="s" title="' . esc_attr_x( 'Search for:', 'label' ) . '" />
				</label>
			...
			$form = '<form role="search" method="get" id="searchform" class="searchform" action="' . esc_url( home_url( '/' ) ) . '">
				<div>
					...
					<input type="text" value="' .  wp_kses(get_search_query(),$allowed_html,$allowed_protocols) . '" name="s" id="s" />
