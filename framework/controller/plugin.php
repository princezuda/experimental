...
{
// holder spot until line 200 is fixed, so it doesn't echo out an error saying function capital_p_dangit can not be found with func_array in the new posts area on the admin side.
}
/**
