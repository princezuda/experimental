...
function wp_signon( $credentials = '', $secure_cookie = '' ) {
	if ( empty($credentials) ) {
		...
		$allowed_protocols = array('http','https');
			$credentials['user_login'] = wp_kses($_POST['log'],$allowed_html,$allowed_protocols);
		}
		if ( ! empty($_POST['pwd']) )
			{
			$allowed_protocols = array('http','https');
			$credentials['user_password'] = wp_kses($_POST['pwd'],$allowed_html,$allowed_protocols);
		}
		if ( ! empty($_POST['rememberme']) )
		{
		$allowed_protocols = array('http','https');
			$credentials['remember'] = wp_kses($_POST['rememberme'],$allowed_html,$allowed_protocols);
	}
	}
